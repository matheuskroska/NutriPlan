export default {
    translations: {
        ...
        instructionsChangePwd: 'Para alterar sua senha, informe o e-mail cadastrado.\nEnviaremos um link com as instruções.',
        sendEmail: 'Enviar e-mail',
        emailSuccessSent: 'E-mail enviado com sucesso',
        setNewPwd: 'Definir nova senha',
        loginNewPwd: 'Fazer login com nova senha',
        tryNewLink: 'Tente solicitar um novo link para alterar sua senha',
        ...
        disable: 'Desativar',
        activate: 'Ativar',
        selNutri: 'Selecione um nutricionista',
        bMakeAppoint: 'Marcar consulta',
        dateTime: 'Data / Hora',
        headerRegister: 'Cadastre-se',
        logout: 'Sair',
        ...
        name: 'Nome',
        dailyNecess: 'Necessidades diárias',
        quantity: 'Quantidade',
        unit: 'Unidade',
        ...
        'Poly Unsaturated Fat': 'Gordura poliinsaturada',
        'Vitamin B3': 'Vitamina B3',
        'Protein': 'Proteína',
        'Calories': 'Calorias',
        'Mono Unsaturated Fat': 'Gordura monoinsaturada',
        'Iron': 'Ferro',
        'Lycopene': 'Licopeno',
        'Fiber': 'Fibra',
        'Calcium': 'Cálcio',
        ...
        'Net Carbohydrates': 'Carboidratos Líquidos',
