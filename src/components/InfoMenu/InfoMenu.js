        ...
        <CardMenuContainer mstate={!menu}>
            ...
            <StyledRadixToggleGroup mstate={menu} value={menuState} height="100%" flexdirection="column" type="single" aria-label="usuario" >
                <CardMenuItem fontSize="inherit" width="100%">
                    ...
                    {currentUser.isNutri && <StyledRadixLink edituserbuttons="true" value={<Translator path="createPlanNutri"/>} aria-label={<Translator path="createPlanNutri"/>}><StyledLink menu="true" link="true" to="/lista-pacientes"><Translator path="createPlanNutri"/></StyledLink></StyledRadixLink>}
