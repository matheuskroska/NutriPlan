    ...
    return (
        <>
            <CardContainer margin={props.margin} borderRadius={props.borderRadius} maxWidth={props.maxWidth} display={props.display}>
                ...
                <CardWrapper className={props.className} padding={props.padding} margin2={props.margin2} bgColor={props.bgColor} boxShadow={props.borderRadius} borderRadius={props.borderRadius}> 
                    {props.children}
                </CardWrapper>
            </CardContainer> 
        </>
